      ...
      <div className="flex flex-col md:w-2/3 w-full md:bg-zinc-100 items-center justify-center ">
        <div className="flex flex-col bg-white md:shadow-lg text-center rounded-2xl py-20 justify-center gap-1">
          ...
          >
            ...
            >
              <svg
                className="absolute w-6 h-fit top-3 md:-left-5 -left-9"
                width="800px"
                height="800px"
                viewBox="0 0 24 24"
                fill="none"
            ...
            <label
              htmlFor="email"
              className="absolute top-[84px] left-20 leading-3 text-xs px-3 bg-white text-center text-gray-400"
            >
              <svg
                className="absolute w-6 h-fit top-3 md:-left-5 -left-9"
                width="800px"
            ...
            <label
              htmlFor="password"
              className="absolute left-20 top-[248px] leading-3 text-xs px-3 bg-white text-center text-gray-400"
            >
              <svg
                className="absolute w-6 h-fit top-3 md:-left-5 -left-9"
                width="800px"
